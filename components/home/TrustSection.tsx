      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl font-serif font-bold text-primary mb-6 flex flex-wrap items-center gap-x-3 gap-y-2">
              ...
              <span className="relative inline-block px-4 py-1 font-sans">
                ...
                <span className="relative text-white">Billing</span>
              </span>
            </h2>
            <ul className="space-y-4 mb-8">
              {['Certified Medical Coders (AAPC/AHIMA)', 'HIPAA Compliant Operations', 'Millions in revenue recovered', 'Seamless EHR integration'].map((item, i) => (
            ...
            <div className="flex gap-4 items-center p-4 bg-bg rounded-lg border border-border">
              ...
              <div>
                <p className="font-semibold text-primary">Sarah Jenkins</p>
                <p className="text-sm text-text-muted">Director of RCM</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-primary text-white p-8 md:p-12 rounded-2xl relative">
            ...
            <p className="mt-4 font-medium">— Dr. Michael T., Clinic Director</p>
          </div>
        </div>
      </div>
    </section>
